...
const InvoicePDF = () => {
    ...
    //                         <div className={`view ${style.flex} ${style.mb5}`}>
    //                             <div className={`view ${style.w40}`}><input type="text" className={`${style.input} ${style.bold}`} placeholder=""
    //                                     value="Invoice#"></div>
    ...
    //                     <div className={`view w-48 ${style.p48}"><input type="text" className={`${style.input} ${style.white} ${style.bold}`} placeholder=""
    //                             value="Item Description"></div>
    //                     <div className={`view ${style.w17} ${style.p48}"><input type="text" className={`${style.input} ${style.white} ${style.bold} ${style.right}`} placeholder=""
    //                             value="Cantidad"></div>
    //                     <div className={`view ${style.w17} ${style.p48}"><input type="text" className={`${style.input} ${style.white} ${style.bold} ${style.right}`} placeholder=""
    //                             value="Precio Ud."></div>
    //                     <div className={`view ${style.w18} ${style.p48}"><input type="text" className={`${style.input} ${style.white} ${style.bold} ${style.right}`} placeholder=""
    //                             value="Total"></div>
    //                 </div>
    //                 <div className={`view ${style.row} ${style.flex}`}>
    ...
    //                     <div className={`view ${style.w17} ${style.p48} ${style.pb10}`}><input type="text" className={`${style.input} ${style.dark} ${style.right}`} placeholder=""
    //                             value="2"></div>
    //                     <div className={`view ${style.w17} ${style.p48} ${style.pb10}`}><input type="text" className={`${style.input} ${style.dark} ${style.right}`} placeholder=""
    //                             value="100.00"></div>
    ...
    //                             <div className={`view ${style.w50} ${style.p5}`}><span className={`${style.span} ${style.right} ${style.bold} ${style.dark}`}>210.00</span></div>
    //                         </div>
    //                         <div className={`view ${style.flex}`}>
    //                             <div className={`view ${style.w50} ${style.p5}`}><input type="text" className={`${style.input}`} placeholder=""
    //                                     value="Impuestos (21%)"></div>
    //                             <div className={`view ${style.w50} ${style.p5}`}><span className={`${style.span} ${style.right} ${style.bold} ${style.dark}`}>44.10</span></div>
    //                         </div>
    //                         <div className={`view flex bg-gray p-5">
    //                             <div className={`view ${style.w50} ${style.p5}`}><input type="text" className={`${style.input} ${style.bold}`} placeholder=""
    //                                     value="TOTAL"></div>
    ...
    //                     </div>
    //                 </div>
    //                 <div className={`view ${style.mt20}`}><input type="text" className={`${style.input} ${style.bold} ${style.w100}`} placeholder=""
    //                         value="Notas adicionales"><textarea className={`${style.input} ${style.w100}`} placeholder=""
    //                         style="height: 48px !important;"></textarea></div>
    //                 <div className={`view ${style.mt20}`}><input type="text" className={`${style.input} ${style.bold} ${style.w100}`} placeholder=""
    //                         value="Terminos y condiciones"><textarea className={`${style.input} ${style.w100}`} placeholder=""
    //                         style="height: 48px !important;"></textarea></div>
    //             </div>
    //         </div>
    //     </div>
